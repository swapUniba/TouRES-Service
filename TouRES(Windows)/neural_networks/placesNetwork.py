...
def placesNetwork():
    dataset = pandas.read_csv("neural_networks/stereotypies/places stereotypies.csv", sep=";", names=["eta", "sesso", "umore", "attivita", "riposo", "salute", "Estroversione", "Amicalita", "Coscienziosita", "Stabilità emotiva", "Apertura mentale", 
    ...
    network.save('neural_networks/h5/places network.h5')
