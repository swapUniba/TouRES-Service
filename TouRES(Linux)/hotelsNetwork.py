...
def hotelsNetwork():
    dataset = pandas.read_csv("stereotypies/hotels stereotypies.csv", sep=";", names=["eta", "sesso", "umore", "attivita", "riposo", "salute", "Estroversione", "Amicalita", "Coscienziosita", "Stabilità emotiva", "Apertura mentale", "ristorante", "bar", "piscina", "parcheggio", "spa", "animali ammessi", "centro fitness", "wifi", "servizio in camera"], 
    ...
    network.save('h5/hotels network.h5')
