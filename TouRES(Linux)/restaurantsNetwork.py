...
def restaurantsNetwork():
    dataset = pandas.read_csv("stereotypies/restaurants stereotypies.csv", sep=";", names=["eta", "sesso", "umore", "attivita", "riposo", "salute", "Estroversione", "Amicalita", "Coscienziosita", "Stabilità emotiva", "Apertura mentale", "italiana", "pizza", "pesce", "mediterranea", "fusion", 
    ...
    network.save('h5/restaurants network.h5')
